...
from typing import Callable, Dict, Protocol, Set, Union
...
class PC(ConstraintDiscovery, MeekRules):
    ...
    def fit(self, X: pd.DataFrame) -> None:
        ...
        graph, sep_set = self._learn_skeleton_from_neighbors(X, graph, sep_set, fixed_edges)
